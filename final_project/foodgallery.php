...
// product details
$products = array(
	array('id' => 1, 'title' => 'Seafood / Shrimp / Lemon', 'link' => '95_12345'),
	array('id' => 2, 'title' => 'Lemon-Rosemary Vegetables', 'link' => '95_123456'),
	array('id' => 3, 'title' => 'Lemon-Rosemary Salad', 'link' => '95_1234567'),
...
function displayProducts($page, $linesPerPage, $maxProducts, $products)
{
	...
	for($x = 0; $x < $linesPerPage; $x++) {
		...
		$output .= '<li>';
		$output .= '<div class="image col-md-3">';
		...
		$output .= '<p class="name"><a href="detail.html">'
				 . $products[$x + $offset]['title']
				 . '</a></p>';
		$output .= '<p class="view"><a href="detail.html">price</a> | <a href="detail.html">view menu >></a></p>';
		$output .= '</div>';
        $output .= '</div>';
		$output .= '</li>';
	}
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="foodgallery.php" class="smoothScroll">FOOD GALLERY</a></li>
				<li><a href="specialmenu.php" class="smoothScroll">SPECIAL MENU</a></li>
                <li><a href="chefs.php" class="smoothScroll">CHEFS</a></li>
			</ul>
		</div>
	</div>
</section>
            ...
            <div class="product-list">
                <div>
                    <div class="text-center">
                            <a class="pages" href="foodgallery.php?page=<?php echo $prev; ?>">&lt;prev</a>
                    &nbsp;|&nbsp;
                            <a class="pages" href="foodgallery.php?page=<?php echo $next; ?>">next&gt;</a>
                    </div>
                    <div class="col-xs-12">
